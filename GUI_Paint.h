...
//Display string
void Paint_DrawChar(UWORD Xstart, UWORD Ystart, const unsigned char Acsii_Char, sFONT* Font, UWORD Color_Background, UWORD Color_Foreground);
void Paint_DrawString_EN(UWORD Xstart, UWORD Ystart, const unsigned char * pString, sFONT* Font, UWORD Color_Background, UWORD Color_Foreground);
